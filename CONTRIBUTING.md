# Contributing to POG2WhyML

First off, thank you for considering contributing to POG2WhyML!
...
1. **Check if the bug has already been reported** by searching the [issues](https://github.com/CLEARSY/POG2WhyML/issues) page.
